...
def generate_h5f(data_path, folder_name, patch_size, stride, number_of_training_images=200):
    '''
    ...
    patch_shape = ( 1,patch_size, patch_size) #before (1,patch_size,patch_size)
